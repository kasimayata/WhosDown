...
namespace ChatsApp
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            titleBar.BackgroundColor = Color.FromArgb(255, 0, 150, 136);
            titleBar.ForegroundColor = Colors.White;
            titleBar.ButtonBackgroundColor = Color.FromArgb(255, 0, 150, 136);  //Maybe Color.FromArgb(255, 88, 232, 112)?
            titleBar.ButtonForegroundColor = Colors.White;

            //Wire up a handler for Window activation...
